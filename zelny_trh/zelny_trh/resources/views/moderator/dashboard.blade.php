...
<div class="container">
    ...
    <a href="{{ route('moderator.kategorie.manage') }}" class="btn btn-primary">Spravovat kategorie</a>
    <a href="{{ route('moderator.atributy.manage') }}" class="btn btn-primary">Spravovat atributy</a>
    <a href="{{ route('moderator.hodnoceni.manage') }}" class="btn btn-primary">Spravovat hodnoceni</a>
                    ...
                    <tbody>
                        @foreach($kategorie as $kategorieItem)
                            <tr>
                                ...
                                <td>
                                <form action="{{ route('moderator.updateCategoryStatus', $kategorieItem->id_kategorie) }}" method="POST">
                                    @csrf
